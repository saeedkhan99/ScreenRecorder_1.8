...
public class Config {
    ...
    public Config(String resolution, String frameRate, String bitRate, String orientation, boolean isEnableRecordAudio, boolean isEnableShowCamera, boolean isEnableShowTouches, boolean isEnableCountdown, String countDownValue) {
